...
public class JrvConstraintLayout extends ConstraintLayout implements JrvInterface<JrvConstraintLayout> {
    ...
    public JrvConstraintLayout(Context context) {
        this(context, null);
    }

    public JrvConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.JrvStyle);
    }

    public JrvConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
